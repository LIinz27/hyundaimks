<!-- hyundai-palisade.blade.php -->
@section('title', 'HYUNDAI PALISADE - Dealer Hyundai Makassar')
@include('header')
        ...
        <div class="carousel-inner">
            @for ($i = 1; $i <= 4; $i++)
                <div class="carousel-item {{ $i == 1 ? 'active' : '' }}">
                    <img src="{{ asset('images/car/hyundai-palisade/' . $i . '.png') }}" class="d-block mx-auto" alt="Hyundai Kona Slide {{ $i }}" style="object-fit: contain; height: 500px;">
                </div>
            @endfor
        </div>
            ...
            <div class="p-4 rounded shadow-sm h-100 w-100" style="background-color: #F1F1F1; border: 1px solid #ddd;">
                ...
                <div class="d-flex flex-column gap-4 mt-3">
                    ...
                    <a href="#" class="btn btn-success fw-bold px-4 py-3" style="background-color: #000000; border: none;">
                        <i class="bi bi-download"></i> Unduh E-Brosur HYUNDAI PALISADE
                    </a>
                </div>
            </div>
        </div>
...
<div class="benefit-section mt-5">
    <div class="benefit-container">
        <ul class="benefit-list">
            <h3 class="benefit-heading">Keuntungan membeli PALISADE di Hyundai Makassar</h3>
...
<!-- Hyundai PALISADE Performance Table -->
