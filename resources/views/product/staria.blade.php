<!-- hyundai-staria.blade.php -->
@section('title', 'HYUNDAI STARIA - Dealer Hyundai Makassar')
@include('header')
        ...
        <div class="carousel-inner">
            @for ($i = 1; $i <= 4; $i++)
                <div class="carousel-item {{ $i == 1 ? 'active' : '' }}">
                    <img src="{{ asset('images/car/hyundai-staria/' . $i . '.png') }}" class="d-block mx-auto" alt="Hyundai Kona Slide {{ $i }}" style="object-fit: contain; height: 500px;">
                </div>
            @endfor
        </div>
            ...
            <div class="p-4 rounded shadow-sm h-100 w-100" style="background-color: #F1F1F1; border: 1px solid #ddd;">
                ...
                <div class="d-flex flex-column gap-4 mt-3">
                    ...
                    <a href="#" class="btn btn-success fw-bold px-4 py-3" style="background-color: #000000; border: none;">
                        <i class="bi bi-download"></i> Unduh E-Brosur HYUNDAI STARIA
                    </a>
                </div>
            </div>
        </div>
...
<div class="benefit-section mt-5">
    <div class="benefit-container">
        <ul class="benefit-list">
            <h3 class="benefit-heading">Keuntungan membeli STARIA di Hyundai Makassar</h3>
...
<!-- Hyundai STARIA Performance Table -->
...
<div class="text-center full-bg" style="margin-top: 50px; background-image: url('{{ asset('images/white-background-with-triangle-patterns_1017-18410.jpg') }}'); background-size: cover; background-position: center;">
    <h2 class="heading-title" style="font-size: 26px; color:#1c4682; font-weight: bolder; margin-bottom: 50px; margin-top: 30px">Video HYUNDAI STARIA</h2>
    <iframe class="yt" width="1280" height="720" src="https://www.youtube.com/embed/jIdpGCdP1Z4" title="HYUNDAI STARIA Paling Mewah Saat Ini" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style = "border-radius: 15px;"></iframe>
</div>
