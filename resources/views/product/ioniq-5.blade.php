...
@section('title', 'HYUNDAI IONIQ 5 - Dealer Hyundai Makassar')
@include('header')
        ...
        <div class="carousel-inner">
            @for ($i = 1; $i <= 5; $i++)
                <div class="carousel-item {{ $i == 1 ? 'active' : '' }}">
                    <img src="{{ asset('images/car/ioniq-5/' . $i . '.png') }}" class="d-block mx-auto" alt="Hyundai Kona Slide {{ $i }}" style="object-fit: contain; height: 500px;">
                </div>
            @endfor
        </div>
            ...
            <div class="p-4 rounded shadow-sm h-100 w-100" style="background-color: #F1F1F1; border: 1px solid #ddd;">
                ...
                <div class="d-flex flex-column gap-4 mt-3">
                    ...
                    <a href="#" class="btn btn-success fw-bold px-4 py-3" style="background-color: #000000; border: none;">
                        <i class="bi bi-download"></i> Unduh E-Brosur HYUNDAI IONIQ 5
                    </a>
                </div>
            </div>
        </div>
...
<div class="benefit-section mt-5">
    <div class="benefit-container">
        <ul class="benefit-list">
            <h3 class="benefit-heading">Keuntungan membeli HYUNDAI IONIQ 5 di Hyundai Makassar</h3>
...
<div class="text-center full-bg" style="margin-top: 50px; background-image: url('{{ asset('images/white-background-with-triangle-patterns_1017-18410.jpg') }}'); background-size: cover; background-position: center;">
    <h2 class="heading-title" style="font-size: 26px; color:#1c4682; font-weight: bolder; margin-bottom: 50px; margin-top: 30px">Video HYUNDAI IONIQ 5</h2>
    <iframe class="yt" width="1280" height="720" src="https://www.youtube.com/embed/S8cThE8V398" title="Power Up the Future with Hyundai IONIQ 5" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="border-radius: 15px;"></iframe>
</div>
