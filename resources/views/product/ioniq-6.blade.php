...
@section('title', 'HYUNDAI IONIQ 6 - Dealer Hyundai Makassar')
@include('header')
...
<div class="benefit-section mt-5">
    <div class="benefit-container">
        <ul class="benefit-list">
            <h3 class="benefit-heading">Keuntungan membeli HYUNDAI IONIQ 6 di Hyundai Makassar</h3>
    ...
    <table class="table table-bordered" style="width: 100%;">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 50%;">Permanent Magnet Synchronous Motor</td>
            </tr>
            <tr>
                <th scope="row" style="width: 50%;">Kapasitas Baterai</th>
                <td style="width: 50%;">77.4 lWh</td>
            </tr>
            <tr>
                <th scope="row" style="width: 50%;">AC charging (0-100%)</th>
                <td style="width: 50%;">(10 to 100%) In 11 Hours 45 Minutes With 7kW & 7 Hours 20 Minutes With 10.5kW Charger</td>
            </tr>
            <tr>
                <th scope="row" style="width: 50%;">Emission</th>
                <td style="width: 50%;">0g/km</td>
            </tr>
        </tbody>
    </table>
...
<div class="text-center full-bg" style="margin-top: 50px; background-image: url('{{ asset('images/white-background-with-triangle-patterns_1017-18410.jpg') }}'); background-size: cover; background-position: center;">
    <h2 class="heading-title" style="font-size: 26px; color:#1c4682; font-weight: bolder; margin-bottom: 50px; margin-top: 30px">Video HYUNDAI IONIQ 6</h2>
    <iframe class="yt" width="1280" height="720" src="https://www.youtube.com/embed/GVcXwIL9OFw" title="IONIQ 6 | Digital World Premiere" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="border-radius: 15px;"></iframe>
</div>
